...
public class BGMainClass {
	...
	public static void main(String[] args) {
		...
		System.out.println("Enter the main method of the BGMainClass");
		...
		System.out.println("BGClient is in " + exeMode + " mode.");
		...
		System.out.println("Exiting BGMainClass main method.");
	}
	...
	private static void checkPortAvailability(String[] args) {
		if (args.length < 2) {
			System.out
					.println(
							"You need to specify a port for the communication between the BGClient and the BGListener");
			System.exit(0);
		}
	}
